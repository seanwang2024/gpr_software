...
- 端到端(4样本): P_R 0.99997 / P_S 0.9999946 / P_T 0.9999991 / **P_U(16点) 0.99996** — 余弦全≥0.9999
- C++: applyRadanAutoGain() 增益面板"增益类型=自动"(点数/整体增益/水平时长三参数), 自检GPR_AGC_TEST=1(PASS)
- ⚠陷阱: 因果平滑初值必须=u(0), scipy lfilter零状态瞬态曾致0.9999被误判0.96(dump法定位一天)
- 待释: C(og)线性外推og>2待样本; P_R逐道wiggle 0.58%幅度来源
